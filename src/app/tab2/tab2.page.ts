...
export class Tab2Page {
  ...
  public salvar() {
    if (this.estoque.nome && this.estoque.marca && this.estoque.tipo && this.estoque.quantidade && this.estoque.precoUnit && this.estoque.estoqueMin) {
      console.log('Salvar', this.estoque);
      this.EstoqueServ.add(this.estoque);
      this.navCtrl.navigateRoot('tabs/tab1');
    } else {
      console.log('Não é possível salvar uma item vazio. Preencha todos os campos');
    }
  }
}
